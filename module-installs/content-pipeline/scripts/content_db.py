...
Usage:
    python scripts/content_db.py              # Initialize or verify database
    python scripts/content_db.py --check      # Show table info and row counts
"""
...
-- Each row is one content idea that moves through: stub -> developed -> scheduled -> created -> editing -> published
CREATE TABLE IF NOT EXISTS content_ideas (
    ...
    -- Production tracking
    production_status TEXT DEFAULT 'stub', -- stub / developed / scheduled / created / editing / published
    ...
    edit_turnaround_days INTEGER,         -- days between creation and publish
...
-- Published content log -- lightweight record of what you have published
